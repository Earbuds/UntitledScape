...
public class NPC {
	...
	/**
	 * If the Monster is praying. 0 = none, 1 = melle, 2 = range, 3 = magic, 4 =
	 * retribution
	 */
	public int praying = 100;

	/**
	 * The basic max hit it can have, with an attack method you can get more
	 * specific.
	 */
	...
	/**
	 * If the death emote has been requested, move on to the next part of the
	 * death process.
	 */
	 ...
	 * 
	 * @param message
	 *            The message to make the NPC say.
	 */
	 ...
	 *            To amount of damage.
	 * @param posion
	 *            0 for normal damage, 1 for posion.
	 */
