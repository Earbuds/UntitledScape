...
public class NPCUpdateMasks {
	 ...
	 * 
	 * @param str
	 *            The stream to save the bytes to.
	 * @param updateData
	 *            The update mask.
	 */
	 ...
	 * 
	 * @param n
	 *            The NPC whos facing target is to be written.
	 * @param str
	 *            The stream to save the bytes to.
	 */
	 ...
	 * 
	 * @param n
	 *            The NPC to display the string for.
	 * @param str
	 *            The stream to dave the bytes to.
	 */
	 ...
	 * 
	 * @param n
	 *            The NPC to request an animation for.
	 ...
	 * 
	 * @param n
	 *            The NPC to write the coords for.
	 * @param str
	 *            The stream to save the bytes to.
	 */
	 ...
	 * 
	 * @param n
	 *            The NPC to request the graphics for.
	 * @param str
	 *            The stream to save the bytes to.
	 */
