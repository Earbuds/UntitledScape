...
public class LevelUp {
	...
	public LevelUp(Player p, int skillID) {
		...
		p.frames.sendMessage(p, "You've just advanced a " + Misc.getSkillName(skillID) + " level! You have reached level " + p.skillLvl[skillID] + "."); // p.skillLvl[skillID]
		p.frames.setString(p, "Congratulations, you have just advanced a " + Misc.getSkillName(skillID) + " level!", 740, 0); // Misc.getSkillname(skillID)
