...
public class Misc {
	 ...
	 */
	public static String[] bonusNames = { "Stab", "Slash", "Crush", "Magic",
	 ...
	 */
	public static byte[] directionDeltaX = new byte[] { -1, 0, 1, -1, 1, -1, 0,
			1 };
	public static byte[] directionDeltaY = new byte[] { 1, 1, 1, 0, 0, -1, -1,
			-1 };

	/**
	 * Update keys sent to the client to finish loading.
	 */
	public static int[] uKeys = {  };

	/**
	 * Characters used to convert a String to a Long.
	 */
	public static char[] validChars = { '_', 'a', 'b', 'c', 'd', 'e', 'f', 'g',
	 ...
	 * 
	 * @param message
	 *            The message to print in the batch file followed by a new line.
	 */
	 ...
	 * 
	 * @param l
	 *            The long to convert to a string.
