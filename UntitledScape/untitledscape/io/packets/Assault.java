...
public class Assault {
	...
	public int[] numNPC = { 2, 4, 6, 8, 10 }; // How many of each NPC to spawn
												// each wave. Currently 5 waves
	public int[] hp = { 25, 40, 65, 80, 100 }; // How much HP each NPC should
												// have each level
	...
	public void deadNPC(int type) {
		...
		if (this.healers - this.khealers < 1) this.healers = 0;
		if (this.runners - this.krunners < 1) this.runners = 0;
		if (this.fighters - this.kfighters < 1) this.fighters = 0;
		if (this.rangers - this.krangers < 1) this.rangers = 0;
