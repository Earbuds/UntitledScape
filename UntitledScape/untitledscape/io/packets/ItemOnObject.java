...
public class ItemOnObject implements Packet {
	...
	public void handlePacket(Player player, int packetId, int packetSize) {
		...
		if (itemUsed == 8 && usedWith == 7) { //
			...
			p.createGlobalObject(8, p.heightLevel, p.cannonC[0], p.cannonC[1],
					0, 10);
		}
		if (itemUsed == 4968 && usedWith == 34573) { // Marigold
			if (player.HerbType > 0) {
				player.frames.sendMessage(player,
						"You can't plant more than one thing at a time.");
			} else {
				player.HerbloreTimer = 30;
				player.HerbloreType = 7867;
				player.HerbType = 1;
				Engine.playerItems.deleteItem(player, 5096,
						Engine.playerItems.getItemSlot(player, 5096), 1);
				player.requestAnim(5212, 0);
				player.createGlobalObject(7867, player.heightLevel, 2809, 3463,
						0, 10);
			}
		}
		if (itemUsed == 4972 && usedWith == 34573) { // Limpwurt
			if (player.HerbType > 0) {
				...
				player.HerbType = 1;
				Engine.playerItems.deleteItem(player, 5100,
						Engine.playerItems.getItemSlot(player, 5100), 1);
				player.requestAnim(5212, 0);
				player.createGlobalObject(7851, player.heightLevel, 2809, 3463,
						0, 10);
			}
		}
		if (itemUsed == 5155 && usedWith == 34573) { // AppleTree
			if (player.HerbType > 0) {
				...
				player.HerbType = 2;
				Engine.playerItems.deleteItem(player, 5283,
						Engine.playerItems.getItemSlot(player, 5283), 1);
				player.requestAnim(5212, 0);
				player.createGlobalObject(7936, player.heightLevel, 2813, 3463,
						0, 10);
			}
		}
		if (itemUsed == 5160 && usedWith == 34573) { // PapayaTree
			if (player.HerbType > 0) {
				...
				player.HerbType = 2;
				Engine.playerItems.deleteItem(player, 5288,
						Engine.playerItems.getItemSlot(player, 5288), 1);
				player.requestAnim(5212, 0);
				player.createGlobalObject(8106, player.heightLevel, 2813, 3463,
						0, 10);
			}
		}
		...
		if (itemUsed == 463 && usedWith == 28173) {
			if (player.skillLvl[7] < 15) {
				player.frames.sendMessage(player,
						"You need level 15 Cooking to cook this.");
			} else {
				player.frames.setString(player, "Cook 1", 458, 1);
				player.frames.setString(player, "Cook 5", 458, 2);
				player.frames.setString(player, "Cook All", 458, 3);
		...
		if (itemUsed == 491 && usedWith == 28173) {
			if (player.skillLvl[7] < 30) {
				player.frames.sendMessage(player,
						"You need level 30 Cooking to cook this.");
			} else {
				player.frames.setString(player, "Cook 1", 458, 1);
				player.frames.setString(player, "Cook 5", 458, 2);
				player.frames.setString(player, "Cook All", 458, 3);
		...
		if (itemUsed == 505 && usedWith == 28173) {
			if (player.skillLvl[7] < 50) {
				player.frames.sendMessage(player,
						"You need level 50 Cooking to cook this.");
			} else {
				player.frames.setString(player, "Cook 1", 458, 1);
				player.frames.setString(player, "Cook 5", 458, 2);
				player.frames.setString(player, "Cook All", 458, 3);
		...
		if (itemUsed == 511 && usedWith == 28173) {
			if (player.skillLvl[7] < 79) {
				player.frames.sendMessage(player,
						"You need level 79 Cooking to cook this.");
			} else {
				player.frames.setString(player, "Cook 1", 458, 1);
				player.frames.setString(player, "Cook 5", 458, 2);
				player.frames.setString(player, "Cook All", 458, 3);
		...
		if (itemUsed == 261 && usedWith == 28173) {
			if (player.skillLvl[7] < 90) {
				player.frames.sendMessage(player,
						"You need level 90 Cooking to cook this.");
			} else {
				player.frames.setString(player, "Cook 1", 458, 1);
				player.frames.setString(player, "Cook 5", 458, 2);
				player.frames.setString(player, "Cook All", 458, 3);
		...
		System.out.println("Used with object: " + usedWith + " itemUsed: "
				+ itemUsed);
	}
