...
public class NPCUpdate extends NPCUpdateMasks {
	 ...
	 * 
	 * @param p
	 *            The Player class to apply updates to.
	 * @param str
	 ...
	 * @param npc
	 *            The NPC to check the distance with.
	 */
	 ...
	 * 
	 * @param n
	 *            The NPC to clear the masks for.
	 */
	 ...
	 * 
	 * @param p
	 *            The player the NPC is being added to.
	 * @param npc
	 *            The NPC being added.
	 * @param str
	 *            The stream the bytes are being written to.
	 */
