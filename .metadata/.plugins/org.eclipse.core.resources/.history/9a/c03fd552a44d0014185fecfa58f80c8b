...
public class Equipment implements Packet {
    ...
    private String[] hats = {
        ...
        "helmet", "mask", "Helm of neitiznot", "Mime mask", "Sleep", "sleep"};
    ...
    private String[] shields = {
        ...
        "shield", "Saradomin kite", "Spirit Shield"};
 ...
 "Prince tunic", "Wizard robe (g)", "Wizard robe (t)" , "Runecrafter robe"};
    private String[] legs = {
        ...
        "skirt (t)", "chaps (g)", "chaps (t)", "tassets", "legs", "Saradomin legs", "trousers"};
    private String[] weapons = {
        "scimitar","Rubber chicken", "longsword", "Swords", "Longsword", "sword", "crozier", "longbow", "shortbow", "dagger",
        ...
        "godsword", "c'bow", "Crystal bow", "Dark bow", "Magic butterfly net", "claws", "banner", "Invisibility", "claws", "Claws", "Warhammer"};

    /* Fullbody is an item that covers your arms. */
    private String[] fullbody = {
        "top", "shirt", "platebody", "Platebody", "Zamorak d'hide", "Ahrims robetop", "Karils leathertop",
    ...
    private String[] fullmask = {
        "full helm", "Slayer helmet", "Veracs helm", "Guthans helm",
...
if ((wearId == 4566) || (wearId == 5554) || (wearId == 1361) || (wearId == 5554) || (wearId == 5555) || (wearId == 5556) || (wearId == 5557) || (wearId == 2653) || (wearId == 2655) || (wearId == 2657) || (wearId == 2659) || (wearId == 2661) || (wearId == 2663) || (wearId == 2665) || (wearId == 2667) || (wearId == 2665) || (wearId == 2667) ||(wearId == 2669) || (wearId == 2671) ||(wearId == 3488) || (wearId == 3486) ||(wearId == 2673) || (wearId == 2675) ||(wearId == 3481) || (wearId == 3483) || (wearId == 534)|| (wearId == 12222)) {
 if ((p.rights < 1) && (p.member < 1)) {    
...
if (Engine.items.getItemName(wearId).toLowerCase().contains(Misc.getSkillName(i).toLowerCase()) && Engine.items.getItemName(wearId).toLowerCase().contains("cape") && p.getLevelForXP(i) < 99) {
p.frames.sendMessage(p, "You are not level 99 in " + Misc.getSkillName(i) + "!");
return;
}
}
if (Engine.items.getItemName(wearId).toLowerCase().contains("woodcut") && Engine.items.getItemName(wearId).toLowerCase().contains("cape") && p.getLevelForXP(8) < 99) {
p.frames.sendMessage(p, "You are not level 99 in Woodcutting!");
return;
}
if (Engine.items.getItemName(wearId).toLowerCase().contains("constru") && Engine.items.getItemName(wearId).toLowerCase().contains("cape") && p.getLevelForXP(22) < 99) {
p.frames.sendMessage(p, "You are not level 99 in Construction!");
return;
}
if (Engine.items.getItemName(wearId).toLowerCase().contains("runecraft") && Engine.items.getItemName(wearId).toLowerCase().contains("cape") && p.getLevelForXP(20) < 99) {
p.frames.sendMessage(p, "You are not level 99 in RuneCrafting!");
return;
}
}
...
if (wearId == 3140 && p.DragonSlayer != 5 || wearId == 1127 && p.DragonSlayer != 5) {
            ...
            if (wearId == 9813 && p.QuestPoints < 2 || wearId == 9814 && p.QuestPoints < 2) {
                p.frames.sendMessage(p,"You must complete all of New Rune's quests to wear this.");
                return;
            }
