...
public class Player {
	...
	public int gettotalz() {
		return getLevelForXP(0) + getLevelForXP(1) + getLevelForXP(2) + getLevelForXP(3) + getLevelForXP(4) + getLevelForXP(5) + getLevelForXP(6) + getLevelForXP(7) + getLevelForXP(8) + getLevelForXP(9) + getLevelForXP(10) + getLevelForXP(11) + getLevelForXP(12) + getLevelForXP(13) + getLevelForXP(14) + getLevelForXP(15) + getLevelForXP(16) + getLevelForXP(17) + getLevelForXP(18) + getLevelForXP(19) + getLevelForXP(20) + getLevelForXP(21) + getLevelForXP(22) + getLevelForXP(23);
	}
	...
	// requestAnim(2068, 0);
	// requestGFX(274, 100);
	// n.appendHit((thirdHit), 0);
	// n.appendHit((fourHit), 0);
	// }
	...
	public String[][] pgeSO = new String[110][5];// all sell the offers: 0 =
													// item, 1 = amt, 2 = price,
													// 3 = username
	public String[][] pgeBO = new String[110][5];// all buy the offers: 0 =
													// item, 1 = amt, 2 = price,
													// 3 = username
	public int modernSpell;
	public String[][] collects = new String[1001][3]; // 0 = item, 1 = amt 2 =
														// string
	public String[][] collectsf = new String[1100][3]; // 0 = item, 1 = amt (f
														// means final)
	...
	public void collectItems(Player p, int item, int amt, int id) {
		...
		if (Engine.playerItems.freeSlotCount(p) < amt && !Engine.items.stackable(item)) {
			...
			p.collectsf[id][0] = "";
			p.collectsf[id][1] = "";
			File curFile = new File("./data/geoffers/collect/collect" + p.collectsf[id][2] + ".txt");
			p.hasCollect = 0;
			p.geoffers--;
			curFile.delete();
		}
	...
	public String readMaps() {
		File curFile = new File("./data/mapdata/12351.txt");
		if (curFile != null) {
	...
	public String maps3() {
		File curFile = new File("./data/mapdata/12352.txt");
		if (curFile != null) {
	...
	/**
	 * 1 set to true means socket disconnected but logged in, both for removing
	 * the player.
	 */
	...
	/**
	 * Open interfaces, use these to confirm an interface is open when trying to
	 * use one.
	 */
	...
	/**
	 * The amount of items that you have last withrawn/deposited with the X
	 * function
	 */
	public int bankX = 50;
	/**
	...
	public Player(Socket socket, int id) {
		...
		mi = new Mining(this);
		File curFile3 = new File("./data/characters/mainsave/" + username + ".txt");
		if (!curFile3.exists()) {
	 ...
	 * <p>
	 * While this is good for for changing integers, this should not be abused.
	 * Things that can be handled else where should be done in that way, such as
	 * clicking the accept button in trade should update in the ActionsButton
	 * class rather than Reqing an update for the process to handle.
	 */
	...
	public void process() {
		...
		if (legendsQuest == 0) {
			frames.setString(this, "Legends Quest", 274, 5);
		} else if (legendsQuest > 0 && legendsQuest < 5) {
			frames.setString(this, "<col=FFFF00>Legends Quest", 274, 5);
		} else if (legendsQuest == 5) {
			frames.setString(this, "<col=66FF33>Legends Quest", 274, 5);
		}
		...
		totalz = getLevelForXP(0) + getLevelForXP(1) + getLevelForXP(2) + getLevelForXP(3) + getLevelForXP(4) + getLevelForXP(5) + getLevelForXP(6) + getLevelForXP(7) + getLevelForXP(8) + getLevelForXP(9) + getLevelForXP(10) + getLevelForXP(11) + getLevelForXP(12) + getLevelForXP(13) + getLevelForXP(14) + getLevelForXP(15) + getLevelForXP(16) + getLevelForXP(17) + getLevelForXP(18) + getLevelForXP(19) + getLevelForXP(20) + getLevelForXP(21) + getLevelForXP(22) + getLevelForXP(23);

		totalXP = skillXP[0] + skillXP[1] + skillXP[2] + skillXP[3] + skillXP[4] + skillXP[5] + skillXP[6] + skillXP[7] + skillXP[8] + skillXP[9] + skillXP[10] + skillXP[11] + skillXP[12] + skillXP[13] + skillXP[14] + skillXP[15] + skillXP[16] + skillXP[17] + skillXP[18] + skillXP[19] + skillXP[20] + skillXP[21] + skillXP[22] + skillXP[23];
		...
		for (Player pg : Engine.players) {
			if (pg != null) {
				...
				Engine.SaradominTeam = SaraPeople[1] + SaraPeople[2] + SaraPeople[3] + SaraPeople[4] + SaraPeople[5] + SaraPeople[6] + SaraPeople[7] + SaraPeople[8] + SaraPeople[9] + SaraPeople[10] + SaraPeople[11] + SaraPeople[12] + SaraPeople[13] + SaraPeople[14] + SaraPeople[15] + SaraPeople[16] + SaraPeople[17] + SaraPeople[18] + SaraPeople[19] + SaraPeople[20] + SaraPeople[21] + SaraPeople[22] + SaraPeople[23] + SaraPeople[24] + SaraPeople[25] + SaraPeople[26] + SaraPeople[27] + SaraPeople[28] + SaraPeople[29] + SaraPeople[30] + SaraPeople[31] + SaraPeople[32] + SaraPeople[33];
				if (AtSaradominRoom()) {
				...
				Engine.ZamorakTeam = ZammyPeople[1] + ZammyPeople[2] + ZammyPeople[3] + ZammyPeople[4] + ZammyPeople[5] + ZammyPeople[6] + ZammyPeople[7] + ZammyPeople[8] + ZammyPeople[9] + ZammyPeople[10] + ZammyPeople[11] + ZammyPeople[12] + ZammyPeople[13] + ZammyPeople[14] + ZammyPeople[15] + ZammyPeople[16] + ZammyPeople[17] + ZammyPeople[18] + ZammyPeople[19] + ZammyPeople[20] + ZammyPeople[21] + ZammyPeople[22] + ZammyPeople[23] + ZammyPeople[24] + ZammyPeople[25] + ZammyPeople[26] + ZammyPeople[27] + ZammyPeople[28] + ZammyPeople[29] + ZammyPeople[30] + ZammyPeople[31] + ZammyPeople[32] + ZammyPeople[33];
				if (AtZamorakRoom()) {
		...
		for (Player pe : Engine.players) {
			if (pe != null) {
				...
				FightEnemys = FightPeople[1] + FightPeople[2] + FightPeople[3] + FightPeople[4] + FightPeople[5] + FightPeople[6] + FightPeople[7] + FightPeople[8] + FightPeople[9] + FightPeople[10] + FightPeople[11] + FightPeople[12] + FightPeople[13] + FightPeople[14] + FightPeople[15] + FightPeople[16] + FightPeople[17] + FightPeople[18] + FightPeople[19] + FightPeople[20] + FightPeople[21] + FightPeople[22] + FightPeople[23] + FightPeople[24] + FightPeople[25] + FightPeople[26] + FightPeople[27] + FightPeople[28] + FightPeople[29] + FightPeople[30] + FightPeople[31] + FightPeople[32] + FightPeople[33];
			...
			for (Player pz : Engine.players) {
				...
				if (pz != null) {
					...
					if (pz.clanchat == clanchannel) {
						...
						pz.ClanCount = ClanMember[1] + ClanMember[2] + ClanMember[3] + ClanMember[4] + ClanMember[5] + ClanMember[6] + ClanMember[7] + ClanMember[8] + ClanMember[9] + ClanMember[10] + ClanMember[11] + ClanMember[12] + ClanMember[13] + ClanMember[14] + ClanMember[15] + ClanMember[16] + ClanMember[17] + ClanMember[18] + ClanMember[19] + ClanMember[12] + ClanMember[20] + ClanMember[21] + ClanMember[22] + ClanMember[23] + ClanMember[25] + ClanMember[26] + ClanMember[27] + ClanMember[28] + ClanMember[29];
		...
		if (absX >= 3150 && absY >= 3476 && absX <= 3181 && absY <= 3505)// Grand
																			// Exchange
		{
		...
		} else if (absX >= 2835 && absY >= 3533 && absX <= 2878 && absY <= 3556)// Combat
																				// Training
		{
		...
		{
			LocatedAt = "Monastary.";
		} else if (absX >= 2652 && absY >= 3409 && absX <= 2685 && absY <= 3449)// Range
																				// Guild
		{
			LocatedAt = "Archery Guild.";
		} else if (absX >= 2692 && absY >= 3417 && absX <= 2711 && absY <= 3433)// Wc
																				// and
																				// fm
		{
		...
		{
			LocatedAt = "Catherby.";
		} else if (absX >= 2928 && absY >= 3275 && absX <= 2950 && absY <= 3290)// Crafting
																				// Guild
		{
		...
		} else if (absX >= 2256 && absY >= 4680 && absX <= 2287 && absY <= 4711)// Slayer
																				// Cave
		{
			LocatedAt = "Slayer Cave.";
		} else if (absX >= 2370 && absY >= 5128 && absX <= 2426 && absY <= 5165)// Fight
																				// Pits
		{
			LocatedAt = "Fight Pits.";
		} else if (absX >= 2394 && absY >= 5169 && absX <= 2404 && absY <= 5175)// Fight
																				// Pits
																				// Waitin
																				// Room
		{
		...
		if (firedelay == 0) {
			// frames.createGlobalObject(2732, heightLevel, absX, absY, 0, 10);
			Engine.items.createGroundItem(592, 1, heightLevel, absX, absY, username);
			firedelay = -1;
		}
		...
		if (freezeDelay > 0) {
			freezeDelay--;
			stopMovement(this);
		} else if (freezeDelay == 0) {// your allowed to walk, what more do you
										// want.
		}
		if (runEnergyDelay > 0) {
			runEnergyDelay--;
	 ...
	 * 
	 * @param skillId
	 *            The skill level to get the level based off XP for.
	 * @return Returns the level based on the amount of XP the specified skill
	 *         has.
	 */
	 ...
	 * 
	 * @param amount
	 *            The amoubt of XP you want to add.
	 * @param skill
	 *            The skill id you want to add it to.
	 */
	 ...
	 * @param delay
	 *            The delay before the teleport is done.
	 * @param distance
	 *            The offset you can teleport to, such as 1 for a max offset of
	 *            x +/- 1 and y +/- 1.
	 * @param emoteStart
	 *            The emote to do right away.
	 * @param emoteEnd
	 *            The emote to do after teleporting.
	 * @param gfxStart
	 *            The graphic to do right away.
	 * @param gfxStartH
	 *            The height level to create the start graphic at.
	 * @param gfxEnd
	 *            The graphic to do after the teleport is done.
	 * @param gfxEndH
	 *            The finish graphic height.
	 */
	 ...
	 * 
	 * @param animId
	 *            The amination to perform.
	 * @param animD
	 *            The delay before doing the animation.
	 */
	 ...
	 * @param gfxD
	 *            The delay or height or the gfx depending on the value.
	 */
		...
		for (int i = 1; i < Engine.players.length; i++) {
			if (Killer == 0) {
				...
				if (killedBy[i] > killedBy[Killer]) {
					Killer = i;
					Count = 1;
				} else if (killedBy[i] == killedBy[Killer]) Count++;
			}
		}
		if (Count > 1) Killer = playerId;
		return Killer;
	}
	...
	public void destruct() {
		...
		if (username != null) {
			if (bountyArea()) Engine.BH.leaveBounty(this);
		}
		stream = null;
		try {
			socket.input.close();
	...
	public void objects() {
		...
		frames.createGlobalObject(28213, 0, 3217, 3217, 1, 10); // Clan Wars
																// Portal
		frames.createGlobalObject(28214, 0, 3223, 3221, 1, 10); // Clan Wars
																// Portal
	...
	int[] DragonImpVeryRare = { 4093, 5547, 1683 };

	public int DragonImpVeryRare() {
		return DragonImpVeryRare[(int) (Math.random() * DragonImpRare.length)];
	}
	
	int[] DragonImpRare = { 1305, 1704, 5300, 7218 };

	public int DragonImpRare() {
		return DragonImpRare[(int) (Math.random() * DragonImpRare.length)];
	}

	int[] DragonImpCommon = { 5316, 1615 };
